...
@FFFTest @all
Scenario Outline: All items checking 2 Fillets Combo
...
@FFFTest
Scenario Outline: All items checking 3 Fillets Combo
Given user able to launch browser and select Place of service for "<product category>"
And I click on "Green" color vehicle model "Car" with Lane "Lane3"
...
@FFFTest
Scenario Outline: All items checking 8 Express Fish Fillets
Given user able to launch browser and select Place of service for "<product category>"
And I click on "Green" color vehicle model "Car" with Lane "Lane3"
